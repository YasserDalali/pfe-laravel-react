...
export default function Home() {
  return (
    <div className="min-h-screen bg-linear-to-br from-background via-background to-purple-50 dark:to-purple-950/20">
      <nav className="sticky top-0 z-50 backdrop-blur-xl bg-background/80 border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="font-serif text-2xl font-bold bg-linear-to-r from-violet-600 to-violet-400 bg-clip-text text-transparent">
            Nexus
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <h1 className="font-serif text-5xl lg:text-6xl font-bold text-balance leading-tight">
              Elevate Your <span className="bg-linear-to-r from-violet-600 to-violet-400 bg-clip-text text-transparent">Scientific</span> Publishing
            </h1>
          ...
          <div className="relative h-96 lg:h-full">
            <div className="absolute inset-0 bg-linear-to-br from-violet-200 via-purple-100 to-transparent dark:from-violet-900/30 dark:via-purple-900/20 dark:to-transparent rounded-3xl" />
            ...
            <div className="relative h-full flex items-center justify-center">
              <div className="w-64 h-64 bg-linear-to-br from-violet-400 to-purple-600 rounded-2xl opacity-10 dark:opacity-5" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32 border-t border-border">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            { icon: BookOpen, title: 'Publication Hub', description: 'Organize and explore all your research publications in one elegant space' },
            { icon: Users, title: 'Team Management', description: 'Collaborate seamlessly with researchers and manage team hierarchies' },
            { icon: BarChart3, title: 'Analytics', description: 'Visualize publication trends and researcher productivity metrics' },
            { icon: Zap, title: 'Real-time Sync', description: 'Instant updates across all devices with automatic synchronization' },
          ].map((feature, index) => (
            <div key={index} className="group p-6 rounded-2xl border border-border bg-card hover:bg-muted transition-all duration-300 hover:border-violet-300 dark:hover:border-violet-700">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
        <div className="relative rounded-3xl overflow-hidden border border-violet-200 dark:border-violet-800 bg-linear-to-br from-violet-50 via-purple-50 to-white dark:from-violet-950/50 dark:via-purple-950/50 dark:to-background p-12 lg:p-20 text-center">
      ...
      <footer className="border-t border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="font-serif text-xl font-bold bg-linear-to-r from-violet-600 to-violet-400 bg-clip-text text-transparent mb-2">
                Nexus
              </div>
