...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-background via-background to-purple-50 dark:to-purple-950/20 flex items-center justify-center p-4">
      <div className="grid md:grid-cols-2 gap-12 max-w-6xl w-full items-center">
        <div className="hidden md:flex flex-col space-y-8">
          <div>
            <Link to="/">
              <div className="font-serif text-3xl font-bold bg-linear-to-r from-violet-600 to-violet-400 bg-clip-text text-transparent mb-2 cursor-pointer hover:opacity-80 transition-opacity">
                Nexus
              </div>
            </Link>
