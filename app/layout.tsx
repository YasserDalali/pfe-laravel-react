...
export const metadata: Metadata = {
  title: "Nexus - Scientific Publications Platform",
  description: "A modern platform for managing and exploring scientific research publications, teams, and researchers.",
  generator: "v0.app",
  icons: {
    icon: [
      {
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${plusJakartaSans.variable} ${ibmPlexMono.variable} ${lora.variable}`}>
